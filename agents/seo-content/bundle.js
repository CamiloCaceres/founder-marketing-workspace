...
(function () {
  ...
  var AGENT_NAME = "SEO & Content";
  var AGENT_TAGLINE = "SEO audits, keyword clusters, blog drafts, content repurposing, AI-search visibility.";
  var ACCENT = "emerald";
  var STAT_LABELS = [
  ...
  var TYPE_COLORS = {
    "seo-audit": "bg-emerald-100 text-emerald-800",
    "keyword-map": "bg-green-100 text-green-800",
    "blog-post": "bg-teal-100 text-teal-800",
    "case-study": "bg-cyan-100 text-cyan-800",
    "repurposed": "bg-sky-100 text-sky-800",
    "content-gap": "bg-lime-100 text-lime-800",
    "backlink-plan": "bg-amber-100 text-amber-800",
    "ai-search-audit": "bg-violet-100 text-violet-800",
          ...
          : sorted.length === 0
            ? h("div", { className: "p-6" },
                h(Empty, {
                  ...
                  suggestion: "Run an SEO audit of my site",
                  onSuggest: function () { sendMessage && sendMessage("Run an SEO audit of my site"); }
                })
              )
