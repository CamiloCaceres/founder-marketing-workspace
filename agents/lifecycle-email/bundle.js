...
(function () {
  ...
  // ------- Lifecycle & Email customization -------
  var AGENT_NAME = "Lifecycle & Email";
  var AGENT_TAGLINE = "Welcome sequences, newsletters, drips, churn-save, product announcements.";
  var ACCENT = "sky";
  var STAT_LABELS = [
  ...
  var TYPE_COLORS = {
    sequence: "bg-sky-100 text-sky-800",
    newsletter: "bg-blue-100 text-blue-800",
    drip: "bg-cyan-100 text-cyan-800",
    save: "bg-teal-100 text-teal-800",
    announcement: "bg-violet-100 text-violet-800",
    default: "bg-slate-200 text-slate-700"
  };
  var QUICK_PROMPTS = [
    "Draft a 5-email welcome series for new signups",
    "Draft this week's newsletter — here's what shipped",
    "Design a re-activation drip for users who signed up but never activated",
    "Draft a save email for accounts that downgraded",
    "Plan the email + in-app announcement for {feature}"
  ];
  // ------------------------------------------------
