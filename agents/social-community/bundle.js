...
(function () {
  ...
  var AGENT_NAME = "Social & Community";
  var AGENT_TAGLINE = "LinkedIn, X, Reddit, social calendar, podcast pitches. Drafts only — I never post.";
  var ACCENT = "rose";
  var STAT_LABELS = [
  ...
  var TYPE_COLORS = {
    "linkedin-post": "bg-rose-100 text-rose-800",
    "x-thread": "bg-pink-100 text-pink-800",
    "community-reply": "bg-fuchsia-100 text-fuchsia-800",
    "social-calendar": "bg-purple-100 text-purple-800",
    "feed-digest": "bg-violet-100 text-violet-800",
    "linkedin-digest": "bg-indigo-100 text-indigo-800",
    "podcast-pitch": "bg-amber-100 text-amber-800",
          ...
          : sorted.length === 0
            ? h("div", { className: "p-6" },
                h(Empty, {
                  ...
                  suggestion: "Draft a LinkedIn post about {topic} in my voice",
                  onSuggest: function () { sendMessage && sendMessage("Draft a LinkedIn post about {topic} in my voice"); }
                })
              )
