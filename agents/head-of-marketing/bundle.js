...
(function () {
  ...
  // ------- Head of Marketing customization -------
  var AGENT_NAME = "Head of Marketing";
  var AGENT_TAGLINE = "Positioning, launches, competitive pulse, the Monday review.";
  var ACCENT = "indigo";
  var STAT_LABELS = [
  ...
  var TYPE_COLORS = {
    ...
    competitor: "bg-slate-100 text-slate-800",
    launch: "bg-amber-100 text-amber-800",
    research: "bg-sky-100 text-sky-800",
    "call-insight": "bg-emerald-100 text-emerald-800",
    review: "bg-rose-100 text-rose-800",
    default: "bg-slate-200 text-slate-700"
  };
  var QUICK_PROMPTS = [
    "Help me write a positioning statement",
    "Build the ICP and persona doc",
    "Weekly competitor pulse — what did they ship?",
    "Plan the launch for my next feature",
    "Give me the Monday marketing review"
  ];
  // ------------------------------------------------
          ...
          : sorted.length === 0
            ? h("div", { className: "p-6" },
                h(Empty, {
                  ...
                  suggestion: "Help me write a positioning statement",
                  onSuggest: function () { sendMessage && sendMessage("Help me write a positioning statement"); }
                })
              )
